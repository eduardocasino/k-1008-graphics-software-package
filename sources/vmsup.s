...
;        CURSOR POSITION BY CHANGING X1CORD AND YICORD. IF THIS IS
...
LNFED4:  INC    ADP2         ; INCREMENT ADP2
         BNE    LNFED5
         INC    ADP2+1
LNFED5:  INC    ADP1         ; TEST IF EQUAL TO CURRENT TOP RIGHT BYTE
         CMP    TRBYT        ; ADDRESS
...
CSR1:    JSR    PIXADR       ; COMPUTE ADDRESS OF CURSOR MARK
         ...
         LDA    Y1CORD       ; RESTORE YICORD BY ADDING CHHIM BACK
         CLC
         ADC    #CHHIM
         STA    Y1CORD
         BCC    CSR2
